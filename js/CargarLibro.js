...
function MostrarEditorial() {
    var agregarEditorial = document.getElementById("agregarEditorial");
    var check =  document.getElementById("agregarEditorialCheckbox"); 
    var editoriales = document.getElementById("editorial");
    var tituloEditorial = document.getElementById("titulo-editorial")

    if (check.checked) {
        agregarEditorial.style.display = "inline-block";
        editoriales.style.display = "none";
        tituloEditorial.style.display = "none";
    }
    else{
        agregarEditorial.style.display = "none";
        editorial.style.display = "inline-block";
        tituloEditorial.style.display = "block";

    }
}

function MostrarIdioma() {
    var agregarIdioma = document.getElementById("agregarIdioma");
    var check =  document.getElementById("agregarIdiomaCheckbox"); 
    var idioma = document.getElementById("idioma");
    var tituloIdioma = document.getElementById("titulo-idioma")

    if (check.checked) {
        agregarIdioma.style.display = "inline-block";
        idioma.style.display = "none";
        tituloIdioma.style.display = "none";
    }
    else{
        agregarIdioma.style.display = "none";
        idioma.style.display = "inline-block";
        tituloIdioma.style.display = "block";
